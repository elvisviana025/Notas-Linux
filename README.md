...
Um dos softwares mais utilizados para a virtualização é o **Virtualbox** da oracle, que ocupa aproximadamente 300 MB de memória.

Para a instalação da Virtualbox e de sistemas operacionais, como o Linux, veja essa playlist do canal **Hardware e Redes Brasil**:

🔗 [Playlist "Curso de Virtualização"](https://www.youtube.com/playlist?list=PLAp37wMSBouCqJnY-Qck_XDwplEud3ELc)

Depois de instalado, caso opte pelo Linux Ubuntu e ele não abra em tela cheia, recomendo este vídeo com um tutorial para abrir o sistema operacional em tela cheia e deixá-lo em tela cheia:
